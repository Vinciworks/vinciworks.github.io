...
console.log("The initial value of the suspenddata on this page is: " + get('cmi.suspend_data'));
scoreInitialize();
currentPage();
getName();
readSuspendData();

//Suspend(?) connection on page exit so that LMS will initialize properly on the next page
